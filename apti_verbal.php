...
<head>
    ...
    <title>Verbal reasoning | CareerTime</title>
</head>
<body>
<?php
    ...
    ?> 
      ...
      <?php
                ...
                $sql="select * from aptitude where topic_name='Verbal Analogies'";
              ...
              <?php
                ...
                $sql="select * from aptitude  where topic_name='Verbal Anologies'";
                $result=mysqli_query($conn,$sql);
                while($row=mysqli_fetch_assoc($result))
                {
